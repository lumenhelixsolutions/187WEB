...
> **Gemini adapter: load as a system instruction.** Canonical source: [`../../.claude/skills/agentic-sprint-handoff/SKILL.md`](../../.claude/skills/agentic-sprint-handoff/SKILL.md).
