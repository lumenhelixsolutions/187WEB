...
name: 187agent-ui
description: >-
  Use for agentic-web frontend engineering — streaming-token DOM rendering,
  human-in-the-loop (HITL) input mechanics, pub/sub agent event buses, and
  agent-flavored data viz (confidence/embedding surfaces). Routes GSAP/motion,
  WebGL rendering, and resilience/performance concerns to their owning skills
