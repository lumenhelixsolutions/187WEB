...
name: neuro-tension
description: >-
  Use when setting inference profiles (exact, analytical, brainstorm, critic,
  synthesis, repo-ingestion, local-npu) or legacy neuro-toxin dose parameters.
suite: 187SKILLS
skill_version: 1.0.0
