...
name: natasha-scout
description: >-
  Use for compliant web and repository research with attribution, rate limits,
  and no authentication or paywall bypass (NATASHA SCOUT module).
suite: 187SKILLS
skill_version: 1.0.0
