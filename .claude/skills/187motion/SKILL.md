---
name: 187motion
description: Reusable React Three Fiber and GSAP hooks for animation patterns, entrance sequences, and scroll triggers — the shared runtime foundation every other motion-lab skill builds on.
origin: motion-lab
skill_version: 2.0.0
