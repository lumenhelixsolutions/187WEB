...
description: >-
  Use when routing across the full 187SKILLS suite or the NATASHA multi-agent
  integration stack (THREAD, COMPRESS, TENSION, SPARK, CORD, SCOUT, LAB, FUSE).
suite: 187SKILLS
skill_version: 3.0.0
...
status: active
replaces: 187web-ecosystem@2.0.0
deprecated: false
compatible_with:
  - 187webdesign >=0.2.0
requires:
