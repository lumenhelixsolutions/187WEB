...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/187webdev-resilience/SKILL.md`](../../.claude/skills/187webdev-resilience/SKILL.md).
