...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/ai-ethics-reviewer/SKILL.md`](../../.claude/skills/ai-ethics-reviewer/SKILL.md).
