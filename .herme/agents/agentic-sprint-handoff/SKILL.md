...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/agentic-sprint-handoff/SKILL.md`](../../.claude/skills/agentic-sprint-handoff/SKILL.md).
