...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/stylistic-unification/SKILL.md`](../../.claude/skills/stylistic-unification/SKILL.md).
