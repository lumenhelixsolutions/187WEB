...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/ml-systems-architect/SKILL.md`](../../.claude/skills/ml-systems-architect/SKILL.md).
