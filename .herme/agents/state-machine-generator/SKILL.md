...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/state-machine-generator/SKILL.md`](../../.claude/skills/state-machine-generator/SKILL.md).
