...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/187webdev-code-review/SKILL.md`](../../.claude/skills/187webdev-code-review/SKILL.md).
