...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/seo-semantic-optimizer/SKILL.md`](../../.claude/skills/seo-semantic-optimizer/SKILL.md).
