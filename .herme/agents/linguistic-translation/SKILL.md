...
> **Hermes adapter: use system.md as the system message.** Canonical source: [`../../.claude/skills/linguistic-translation/SKILL.md`](../../.claude/skills/linguistic-translation/SKILL.md).
