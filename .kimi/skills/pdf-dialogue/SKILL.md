...
> **Kimi adapter: load via the Kimi Skill tool or skills directory.** Canonical source: [`../../.claude/skills/pdf-dialogue/SKILL.md`](../../.claude/skills/pdf-dialogue/SKILL.md).
