...
> **Kimi adapter: load via the Kimi Skill tool or skills directory.** Canonical source: [`../../.claude/skills/document-summarization/SKILL.md`](../../.claude/skills/document-summarization/SKILL.md).
