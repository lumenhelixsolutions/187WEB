...
> **Kimi adapter: load via the Kimi Skill tool or skills directory.** Canonical source: [`../../.claude/skills/silk-sandbox/SKILL.md`](../../.claude/skills/silk-sandbox/SKILL.md).
