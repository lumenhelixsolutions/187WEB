...
> **Kimi adapter:** Load via the Kimi Skill tool or place in your Kimi skills directory. Source: [`../../.claude/skills/187access-plus/SKILL.md`](../../.claude/skills/187access-plus/SKILL.md).
