# 187research — Public Skill Doc

> **Canonical skill:** [`.claude/skills/187research/SKILL.md`](.claude/skills/187research/SKILL.md)  
> **CLI:** `187repo.sh research`
...
- **Skill source:** `.claude/skills/187research/SKILL.md`
- **Docs:** `docs/187RESEARCH.md`
- **CLI:** `187repo.sh research`
