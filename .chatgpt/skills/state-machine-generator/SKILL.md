...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/state-machine-generator/SKILL.md`](../../.claude/skills/state-machine-generator/SKILL.md).
