...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/seo-semantic-optimizer/SKILL.md`](../../.claude/skills/seo-semantic-optimizer/SKILL.md).
