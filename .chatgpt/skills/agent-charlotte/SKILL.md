...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/agent-charlotte/SKILL.md`](../../.claude/skills/agent-charlotte/SKILL.md).
