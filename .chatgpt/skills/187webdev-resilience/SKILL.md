...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/187webdev-resilience/SKILL.md`](../../.claude/skills/187webdev-resilience/SKILL.md).
