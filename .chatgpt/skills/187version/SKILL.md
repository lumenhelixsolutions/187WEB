...
> **ChatGPT adapter:** Use the markdown below as the custom GPT / system instructions. Source: [`../../.claude/skills/187version/SKILL.md`](../../.claude/skills/187version/SKILL.md).
