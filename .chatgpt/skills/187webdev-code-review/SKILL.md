...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/187webdev-code-review/SKILL.md`](../../.claude/skills/187webdev-code-review/SKILL.md).
