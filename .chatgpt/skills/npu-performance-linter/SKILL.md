...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/npu-performance-linter/SKILL.md`](../../.claude/skills/npu-performance-linter/SKILL.md).
