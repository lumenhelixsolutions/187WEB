...
> **ChatGPT adapter:** Use the markdown below as the custom GPT / system instructions. Source: [`../../.claude/skills/neuro-tension/SKILL.md`](../../.claude/skills/neuro-tension/SKILL.md).
