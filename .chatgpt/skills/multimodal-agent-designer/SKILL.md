...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/multimodal-agent-designer/SKILL.md`](../../.claude/skills/multimodal-agent-designer/SKILL.md).
