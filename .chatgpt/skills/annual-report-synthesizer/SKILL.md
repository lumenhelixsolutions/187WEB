...
> **ChatGPT adapter: use as custom GPT or system instructions.** Canonical source: [`../../.claude/skills/annual-report-synthesizer/SKILL.md`](../../.claude/skills/annual-report-synthesizer/SKILL.md).
