...
> **ChatGPT adapter:** Use the markdown below as the custom GPT / system instructions. Source: [`../../.claude/skills/natasha-scout/SKILL.md`](../../.claude/skills/natasha-scout/SKILL.md).
