...
> **ChatGPT adapter:** Use the markdown below as the custom GPT / system instructions. Source: [`../../.claude/skills/187revenue/SKILL.md`](../../.claude/skills/187revenue/SKILL.md).
