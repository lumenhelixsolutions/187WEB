...
export const skillShowcases: SkillShowcaseData[] = [
  ...
  },
  {
    id: "access",
    name: "187ACCESS+",
    tagline: "Disability access + assistive tech",
    color: "#ec4899",
    description:
      "Audits and improves disability access: vision, hearing, motor, and assistive tech. Uses WCAG, ARIA, keyboard paths, captions, and focus order in one review.",
    triggers: [
      "/187access",
      "/187access-plus",
      "187ACCESS+",
    ...
    useCases: [
      ...
      "Motion and photosensitive safety checks",
    ],
    outputs: [
  ...
  },
  {
    ...
    useCases: [
      "Neurodivergent-friendly UX review (Autism, ADHD, and more)",
    ...
    outputs: [
      ...
      "Neurodivergent and sensory notes",
