...
export const skillShowcases: SkillShowcaseData[] = [
  ...
  },
  {
    ...
    color: "#f59e0b",
    description:
      "Reviews smart contracts and DeFi risk with clear severity and confidence scores. Uses responsible disclosure. Never asks for live keys or writes exploits.",
    triggers: [
      "/187chain",
      "/187 chain",
      "187CHAIN",
    ...
    useCases: [
      "Scope a contract or protocol audit",
      "Map DeFi economic and technical risks",
      "Separate severity from confidence on findings",
      "Plan responsible disclosure and retest",
    ],
    outputs: [
      "Scoped findings list",
      "Severity and confidence matrix",
      "DeFi risk vector notes",
      "Disclosure draft",
      "Retest checklist",
    ],
    related: ["natasha", "research", "test"],
  },
  {
    id: "gsap",
    name: "187GSAP",
    tagline: "GSAP timeline + ScrollTrigger",
    color: "#85c918",
    description:
      "Plans GSAP timelines and ScrollTrigger motion for React and Next.js. Keeps motion transform-safe and reduced-motion friendly.",
    triggers: [
      "/187gsap",
      "187GSAP",
      "gsap",
    ...
    useCases: [
      "Build a timeline for a page or component",
      "Add ScrollTrigger pin, scrub, or progress motion",
      "Standardize easing, stagger, and reduced-motion fallbacks",
      "Hand off reusable hooks to 187MOTION",
    ],
    outputs: [
    ...
    routesTo: [
      ...
      { name: "187ACCESS+", when: "motion may affect vestibular or photosensitive users" },
    ],
    templates: [
  ...
  },
  {
    ...
    color: "#f472b6",
    description:
      "Designs kinetic, variable, and 3D type that reacts to scroll, audio, or input — without hurting readability.",
    triggers: [
      "/187type",
      "187TYPE",
      "type",
    ...
    useCases: [
      ...
      "Check type motion for readability and reduced-motion",
    ],
    outputs: [
      "Type motion spec",
  ...
  },
  {
    ...
    color: "#22d3ee",
    description:
      "Builds interactive 3D product viewers: load models, swap materials, set cameras, and design configurator UX.",
    triggers: [
      "/187model",
      "187MODEL",
      "model",
    ...
    useCases: [
      ...
      "Budget load time and frame rate for real devices",
    ],
    outputs: [
  ...
  },
  {
    ...
    color: "#a78bfa",
    description:
      "Builds scroll-driven 3D stories: camera paths, scene changes, and progress-based reveals with accessible fallbacks.",
    triggers: [
      "/187scroll",
      "187SCROLL",
      "scroll",
    ...
    useCases: [
      ...
      "Avoid scroll-trap patterns that break keyboard use",
    ],
    outputs: [
      "Scroll progress map",
      "Camera path spec",
  ...
  },
  {
    ...
    color: "#f87171",
    description:
      "Connects Web Audio to Three.js so meshes react to music or mic input, with clear permission and safety notes.",
    triggers: [
      "/187audio",
      "187AUDIO",
      "audio",
    ...
    useCases: [
      ...
      "Avoid autoplay audio and harsh flashing effects",
    ],
    outputs: [
      "Audio node graph",
  ...
  },
  {
    ...
    color: "#2dd4bf",
    description:
      "Turns network and spatial data into 3D graphs and stories people can explore with clear interaction labels.",
    triggers: [
      "/187viz",
      "187VIZ",
      "viz",
    ...
    useCases: [
      ...
      "Add keyboard and screen-reader friendly selection",
    ],
    outputs: [
  ...
  },
  {
    ...
    color: "#fbbf24",
    description:
      "Creates reusable R3F and GSAP hooks for entrances, scrolls, and interactions so motion stays consistent and safe.",
    triggers: [
      "/187motion",
      "187MOTION",
      "motion",
    ...
    useCases: [
      ...
      "Bake reduced-motion defaults into the hook API",
    ],
    outputs: [
  ...
  },
  {
    id: "hero",
    name: "187HERO",
    tagline: "Immersive 3D hero systems",
    color: "#39FF14",
    description:
      "Designs full-screen WebGL/R3F heroes with parallax layers and clear CTAs, plus a realistic performance budget.",
    triggers: [
      "/187hero",
      "187HERO",
      "hero",
    ...
    useCases: [
      ...
      "Ship a static or reduced-motion hero fallback",
    ],
    outputs: [
      "Hero scene spec",
...

  {
    ...
    color: "#10b981",
    description:
      "Finds free, free-tier, open-source, and local-first tools that fit real budgets — with backups when free tiers end.",
    triggers: [
      "/187free",
      "187FREE",
      "free",
    ...
    useCases: [
      ...
      "Plan an upgrade path when free limits hit",
    ],
    outputs: [
      "Restated need",
  ...
  },
  {
    ...
    color: "#a855f7",
    description:
      "Helps public pages get found through technical SEO, content briefs, schema, and search analytics — without ranking guarantees.",
    triggers: [
      "/187seo",
      "187SEO",
      "seo",
  ...
  },
  {
    ...
    color: "#f97316",
    description:
      "Designs ethical pricing and payments: offers, subscriptions, affiliates, and commerce ops — with refund and compliance gates, no revenue promises.",
    triggers: [
      "/187revenue",
      "187REVENUE",
      "revenue",
  ...
  },
  {
    id: "access",
    name: "187ACCESS+",
    tagline: "Disability + neurodivergent + assistive access",
    color: "#ec4899",
    description:
      "Premier access skill: disability access (vision, hearing, motor), ADHD and neurodivergent usability, cognitive load, sensory safety, and assistive technology. WCAG, ARIA, keyboard paths, captions, focus order, and reduced-motion in one review.",
    triggers: [
      "/187access",
      "/187access-plus",
      "187ACCESS+",
    ...
    useCases: [
      "Screen-reader and keyboard audit for pages, apps, and forms",
      "Low-vision review: contrast, zoom, reflow, focus indicators",
      "ADHD / autism / OCD / dyslexia-friendly structure and cognitive-load review",
      "Captions, transcripts, and audio description planning",
      "Motor/switch-friendly targets and gesture alternatives",
      "Motion, vestibular, and photosensitive safety checks",
    ],
    outputs: [
      "Accessibility profile",
      "WCAG/ARIA findings with severity",
      "Neurodivergent and cognitive-load notes",
      "Keyboard and screen-reader test plan",
      "Caption/transcript plan",
      "Contrast and focus-order notes",
      "Validation steps",
    ],
    routesTo: [
      { name: "187INCLUDE+", when: "forms or content touch identity, pronouns, or LGBTQ+ safety" },
    ...
    templates: [
      ...
      { name: "neurodivergent-ux-checklist.md", when: "ADHD/autism/cognitive structure review" },
    ],
  ...
  },
  {
    ...
    color: "#f43f5e",
    description:
      "The universal `/187` command surface. Parses aliases, modes, and depths, then routes work to the right skill.",
    triggers: [
      "/187",
      "187COMMAND",
      "187",
  ...
  },
  {
    ...
    color: "#39FF14",
    description:
      "Kali’s growth skill: landing pages, ad creatives, and conversion surfaces that plug into 187WEB — then hand off to craft and publish.",
    triggers: [
      "/187create",
      "187CREATE",
      "create",
  ...
  },
  {
    id: "include",
    name: "187INCLUDE+",
    tagline: "LGBTQ+ inclusion + identity safety + anti-bias",
    color: "rainbow",
    description:
      "Premier inclusion skill for LGBTQ+ safety, names and pronouns, identity fields, privacy, anti-bias language, and community safety. Pairs with 187ACCESS+ for disability and neurodivergent access; /187++ runs both.",
    triggers: [
      "/187include",
      "/187INCLUDE+",
      "187INCLUDE+",
    ...
    useCases: [
      ...
      "Anti-bias copy and community safety language",
      "Privacy-aware identity data collection",
      "Code of conduct and support-response language",
    ],
    outputs: [
      "Inclusion scope and mode",
      "Identity and pronoun recommendations",
      "Anti-bias copy findings",
      "Prioritized fix list",
      "Validation steps",
    ],
    routesTo: [
      { name: "187ACCESS+", when: "disability, ADHD/neurodivergent, sensory, or assistive-tech review" },
    ...
    templates: [
      ...
      { name: "plain-language-rewrite.md", when: "Simplifying public copy (with WRITE)" },
    ],
    related: ["access", "docs", "write", "publish"],
  },
  {
    id: "spider-sense",
    name: "187SPIDER-SENSE",
    tagline: "Project aura · novel skillchain detection",
    color: "#a855f7",
    description:
      "XAVIER’s project-aura skill: senses when a skillchain succeeds or a novel skill/chain is emerging, conceives a logical goal plan, calls for a build, and advances only through human-in-the-loop Q&A before executing a new feature or skill.",
    triggers: [
      "/187spider-sense",
      "/187 spider-sense",
      "/187 aura",
      ...
      "project aura",
      "novel skillchain",
      "skillchain succeeded",
      "HITL skill build",
    ],
    useCases: [
      "Detect a newly successful multi-skill chain and propose promotion",
      "Notice novel skill or skillchain development in the suite",
      "Draft a goal plan and build call for a new feature or skill",
      "Run HITL Q&A before executing the build",
      "Log council + version tags for the decision",
    ],
    outputs: [
      "Aura signal (success | novel | none)",
      "Goal plan and build proposal",
      "HITL Q&A packet",
      "Go / no-go / revise decision",
      "Versioned decision log",
    ],
    routesTo: [
      { name: "187CRAFT", when: "the build is a design/UI surface" },
      { name: "187CREATE", when: "the build is a growth surface" },
      { name: "187REPO", when: "the build needs scaffolding" },
      { name: "187VERSION", when: "tagging the decision or skill version" },
      { name: "187PUBLISH", when: "shipping after HITL approval" },
      { name: "187TEST", when: "validating the new chain or skill" },
    ],
    templates: [
      { name: "spider-sense-signal.md", when: "Logging an aura detection" },
      { name: "hitl-skill-build-qna.md", when: "Human-in-the-loop gate before execute" },
      { name: "novel-skillchain-plan.md", when: "Goal plan for a new skill or chain" },
    ],
    related: ["version", "publish", "docs", "test", "craft", "create", "repo"],
  },
  {
    id: "theme",
    name: "187THEME",
